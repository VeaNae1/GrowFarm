# GrowFarm
잎 결핍 원소 분석을 위한 모델과 어플리케이션
## Pipeline
<img width="1734" height="617" alt="파이프라인" src="https://github.com/user-attachments/assets/c4010af4-eada-4369-a52a-3f1c7d63c7a7" />

## Purpose
* 식물의 잎 사진을 받아 이미지 분석
* 분석 결과를 토대로 결핍 가능성 분석
* 사용자에게 필요한 대응 추천
...
<img width="1578" height="415" alt="데이터셋 예시" src="https://github.com/user-attachments/assets/2ae94a3a-748d-4c0b-8dc2-2da344207be0" />

## Key Features
* 앱에서 사진 촬영 및 갤러리 접근 후 선택
* 서버를 통해 모델로 사진 전송
